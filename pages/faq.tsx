...
export default function FAQ() {
    ...
    const faqs = [
        ...
        {
            question:
                'How can I track my debt and set up a debt reduction plan?',
                                ...
                                <div className="">
                                    <dt className="border-2 rounded-md dark:!border-indigo-500 h-12">
                                        <div className="flex w-full h-full relative items-start justify-between text-left text-gray-900 dark:text-slate-100 px-2">
                                            <div
                                                className="absolute z-10 w-full h-full top-0 left-0 right-0 bottom-0 cursor-pointer"
                                                onClick={() => {
                                                    setIsOpen({
                                                        ...isOpen,
                                                        [index]: !isOpen[index],
                                            ...
                                            ></div>
                                            <span className="text-base font-semibold leading-7 my-2">
                                                {faq.question}
                                            </span>
