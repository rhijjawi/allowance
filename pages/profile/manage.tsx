    ...
    return (
        ...
        >
            <UserProfile
                path="/profile/manage"
                routing="virtual"
                appearance={{ elements: { rootBox: 'mx-auto h-fit my-10' } }}
            >
                <UserProfile.Page label="account" />
                <UserProfile.Page label="security" />
                {user && user.publicMetadata.role !== 'parent' && (
                    <UserProfile.Page
                        label="Expenditure"
                        url="expenditure"
                        ...
                        <div className="w-full h-fit">
                            <div className="my-3 max-w-sm mx-auto">
                                <label
                                    ...
                                    className="text-md block mb-2 font-medium leading-none text-gray-700 dark:text-black"
                                >
                                    Monthly Budget
                                </label>
                    ...
                    icon={CalendarIcon} className="h-full px-2 aspect-square"></Button> */}
                                ...
                                <label
                                    htmlFor="monthlyBudget"
                                    className="text-md block font-medium leading-none text-gray-700 mt-8 mb-2 dark:text-black"
                                >
                ...
                >
                    <div className="w-full h-24">
                        ...
                        <div className="mx-auto w-fit py-3">
                            <Button
                                variant="primary"
                                className="mx-auto w-fit bottom-0 right-0 left-0 top-0"
                                onClick={async () => {
                                    fetch(
                                        `/api/stripe/createPortalSession?backurl=${router.pathname}`,
                                        { method: 'POST' }
                                    ).then((res) => {
                                        if (res.status === 200) {
                                            res.json().then((data) => {
