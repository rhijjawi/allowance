...
function Card(props: any, { ...rest }) {
    return (
        <div
            className={`divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow w-full mt-5 max-w-[80%] my-auto mx-auto border-2 ${props.className}`}
        >
            <div className="px-4 py-5 sm:px-6 text-lg dark:bg-dark-tremor-background">
                {props.header}
            </div>
            <div className="pt-5 sm:pt-6 dark:bg-dark-tremor-background">
                {props.children}
            </div>
            ...
            <Card
                ...
                footer={
                    <span className="text-stone-500">
                        Change your profile picture on{' '}
                        <a
                            target="_blank"
                            className="text-[rgb(29,79,196)]"
                            href={'https://gravatar.com/'}
                        >
                            Gravatar
                        </a>
                        <br />
                        If you're running into any issues, feel free to contact
                        us at:{' '}
                        <a
                            className="text-blue-300 underline"
                            href={`mailto:expenses@ramzihijjawi.me`}
                        >
                            expenses@ramzihijjawi.me
                        </a>
                    </span>
                }
            >
                ...
                <div className="my-3 max-w-sm mx-auto">
                    ...
                    <label
                        ...
                        className="text-md block mb-2 font-medium leading-none text-gray-700 dark:text-white"
                    >
                        Monthly Budget
                    </label>
                    ...
                    <label
                        htmlFor="monthlyBudget"
                        className="text-md block font-medium leading-none text-gray-700 mt-8 mb-2 dark:text-white"
                    >
                    ...
                    <div className="grid grid-cols-10">
                        ...
                        <div className="col-span-1 col-start-10 ml-5">
                            <Button
                                tooltip={
                                    !wasOpened
                                        ? 'What day of the month do you get your income/allowance?'
                                        : `You receive your income/allowance on the ${date}${nth(date)} day of each month`
                                }
                                icon={CalendarIcon}
                                className={`${!wasOpened ? 'dark:border-red-500' : ' dark:border-green-500'} border-2 h-full px-2 aspect-square float-right`}
                                onClick={() => {
                                    setIsOpen(true)
                                    setWasOpened(true)
                                }}
                            ...
                            >
                                ...
                                <div className="fixed inset-0 flex w-screen items-center justify-center p-4 ">
                                    <Dialog.Panel
                                        className={`rounded-md relative w-full bg-white dark:bg-black max-w-2xl h-fit  max-h-full border-2 border-green-600 dark:border-green-600`}
                                    >
                                        <Dialog.Title
                                            className={
                                                'flex bg-emerald-400 items-start justify-between p-4 border-b rounded-t dark:border-white dark:text-white text-black'
                                            }
                                        >
                                            Income
                                        </Dialog.Title>
                                        <div className="p-6 rounded-md space-y-4">
                                            <label
                                                htmlFor="monthlyBudget"
                                                className="text-md block font-medium leading-none text-gray-700 dark:text-white mt-0 mb-2"
                                            >
                                                When do you recieve your
                                                paycheck, allowance, or income?
                                            </label>
                                            ...
                                            <div className="z-[120] relative h-fit">
                                                <Text>
                                                    You recieve your paycheck,
                                                    allowance, or income on the{' '}
                                                    {date}
                                                    {nth(date)} day of each
                                                    month.
                                                </Text>
                                            </div>
                                        </div>
                                        <div className="relative w-fit mb-3 right-0 bottom-0 left-0 mx-auto">
                                            <Button
                                                ...
                                                className="h-10 pt-4 py-2 mx-auto relative"
                                            >
                                                Done
                                            </Button>
                                        </div>
                ...
                <div className="w-fit mx-auto right-0 left-0 bottom-0">
                    <Button
                        ...
                        className="relative mx-auto my-5 py-2 px-3"
                    >
                        Save Changes
                    </Button>
                </div>
