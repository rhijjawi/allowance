              ...
              <div className="col-start-1 lg:pr-8 lg:pt-4">
                <div className="lg:max-w-lg">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-white">
                    A comprehensive financial management platform to help you
              ...
              <div className="col-start-1 lg:pr-8 lg:pt-4">
                <div className="lg:max-w-lg">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                    Your comprehensive financial management platform to help YOU
                    regain control of your finances.
                  </p>
            ...
            >
              <div className="col-start-1 lg:pr-8 lg:pt-4">
                <div className="lg:max-w-lg">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                    A platform built to help your children through their journey
          ...
          >
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <button className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                {!user && <Link href="/sign-up">Get started</Link>}
                {user && <Link href="/expenditure/overview">My Dashboard</Link>}
              </button>
              <Link
                href="/faq"
