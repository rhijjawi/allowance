    ...
    <>
      <main className="bg-dark-tremor-background-muted/75 min-h-screen p-12">
        ...
        <TabGroup className="mt-6" index={tab} onIndexChange={setTab}>
          <TabList>
            <Tab icon={EyeIcon} className="text-white hover:text-slate-400">
              Overview
            </Tab>
            <Tab
              icon={TableCellsIcon}
          ...
          <TabPanels>
            <TabPanel>
              ...
              >
                <Card className="h-fit min-h-80 border-2 border-slate-400 bg-white">
                  {user ? (
                    <DonutCategory
                      ...
                      <b>
                        {currFormatter(
                          expenseData
                            ...
                            .reduce((a, b) => {
                              return a + b.standardizedCurrency!;
                            }, 0),
                ...
                <Card className="w-full border-2 border-slate-400 bg-white shadow-md">
                  ...
                  <MIMO
                    income={incomeData}
                    currency={user!.publicMetadata.currency as string}
                  />
                </Card>
                ...
                <Col numColSpan={1} numColSpanLg={3}>
                  <Card className=" relative dark:border-2">
                    ...
                    <div className="relative grid grid-cols-1 md:lg:grid-cols-3">
                      {categoryData.map(
                        (item: CategorySchema, index: number) => {
                          return (
                            <ExpenditureDelta
                              category={item}
                              key={index}
              ...
              >
                <Card className="mx-auto aspect-[3/1] w-[32rem]">
                  ...
                  <Callout
                    ...
                    color="orange"
                  >
                    The list of supported banks is constantly growing, so if you
                    don't see your bank, please submit a request via the Report
                    Bug button in the bottom right corner.
                  </Callout>
                  <Subtitle className="my-2 select-none">
                    You can import transactions from your bank account by
                    selecting your bank from the dropdown below.
                  </Subtitle>
                  <Select
                    className="my-3"
                    value={bank}
