            ...
            <div className="h-fit w-full overflow-hidden border-t-2 bg-white dark:bg-black">
                <div className="mx-auto mb-5 min-h-screen max-w-[88rem] px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div
                            className={`h-fit grid grid-rows-1 grid-cols-${user ? (user.publicMetadata.role == 'student' ? 4 : 3) : 4}`}
                        >
                            <Card className="mx-auto w-[90%] top-0 h-full inline-block text-center">
                                ...
                                <p className="select-none text-xs  dark:text-stone-200">
                                    LogMoney.app is a tool made by spenders, for
                                    spenders. Managing your finances shouldn't
                                    come at a cost.
                                </p>
                                ...
                                {!isSignedIn && isLoaded && (
                                    <MotionButton
                                        ...
                                        onClick={() => {
                                            router.push(
                                                '/sign-up?redirect_url=/expenditure/overview'
                                            )
                                        }}
                                    >
                                        Sign Up
                                ...
                                return (
                                    <Card className="mx-auto w-[90%] top-0 h-full inline-block text-center">
                                        ...
                                        <div className="absolute top-2 right-2">
                                            <span className="font-bold text-indigo-400 align-super">
                                                ＊
                                            </span>
                                        </div>
                                        <p className="select-none text-xs  dark:text-stone-200">
                                            ...
                                            <MotionButton
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    if (
                                                        ...
                                                        return addAlert(
                                                            'error',
                                                            "You're not signed-in with a parent account",
                                                            3000
                                                        )
                                                    }
                                                    if (
                        ...
                        <p className="mt-4 text-center align-bottom text-sm text-indigo-500">
                            <span className="text-indigo-400 text-lg">＊</span>{' '}
                            These subscriptions are <strong>only</strong> for
                            Guardians/Supervisors
                        </p>
                        <p className="mt-1 text-stone-500 text-center">
                            Your payment information is handled by Stripe. We
                            never see any of your sensitive payment information.
                        </p>
                    </Card>
                </div>
            </div>
