              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">February 14, 2024</bdt>
                  </span>
                </span>
              </strong>
            </span>
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: "rgb(127, 127, 127)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="question">privacy@logmoney.app</bdt>.
                  </span>
                </span>
              </span>
            </div>
                          ...
                          <span data-custom-class="body_text">
                            ...
                            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                              ...
                              >
                                <span data-custom-class="body_text">
                                  <bdt className="question">
                                    We at Logmoney.com use Simple Analytics for
                                    website analytics. Simple Analytics collects and
                                    processes anonymous metrics and provides us with
                                    information to help us understand how visitors use
                                    our website and where our traffic comes from.
                                  </bdt>
                                </span>
                              </span>
                            </span>
                          ...
                          <span data-custom-class="body_text">
                            ...
                            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                              ...
                              >
                                <span data-custom-class="body_text">
                                  <bdt className="question">
                                    We use Clerk.com's authentication services to
                                    handle your log-in information. For more detailed
                                    information, visit{" "}
                                    <a
