...
export default function Index() {
    ...
    useEffect(() => {
        ...
        const hasAgreedDisclaimer =
            localStorage.getItem('modals')?.indexOf('disclaimer') != -1
    ...
    if (!isLoaded)
        return (
            <div className="mx-auto max-w-[88rem] min-h-screen px-6 lg:px-8  mb-5"></div>
        )
        ...
        <AnimatePresence>
            <LegalModal isOpen={visible} setIsOpen={setVisible} />
            {
                <div className="mx-auto max-w-[88rem] min-h-screen px-6 lg:px-8  mb-5">
                    ...
                    >
                        <motion.p className="text-4xl mb-4 leading-7">
                            Debt
                        </motion.p>
                        {isSignedIn && (
                        ...
                        <motion.p className="mb-4 leading-7">
                            ...
                            achieving financial goals. It involves understanding
                            the various types of debt, evaluating their terms
                            and interest rates, and devising a structured plan
                        ...
                        >
                            <motion.p className="text-4xl mb-3 leading-10">
                                Stuck in debt?
                            </motion.p>
                            <motion.p className="mb-4 text-base leading-7">
                                Paying off debt is no easy task, especially if
                                you pay the minimum amount due each month. To
                                get free and clear, you often have to accelerate
                                payments. There are two distinct strategies to
                        ...
                        >
                            ...
                            <motion.p className="text-sm mt-5">
                                ...
                                this calculator provides you with a solution.
                            </motion.p>
                            <motion.p className="text-xs mb-5 mt-1">
                                Keep in mind that this calculator is only a tool
                                to help you understand your debt and how to pay
                                it off. It is not a substitute for professional
                                advice. If you are struggling with debt, you
                            ...
                            <MotionButton
                                ...
                                className="py-2 px-3"
                            >
                                Continue to the Debt Calculator
                            </MotionButton>
                        </motion.div>
                    </motion.div>
                </div>
