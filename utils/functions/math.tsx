...
import { standardizeCurrency, standardizeCurrencyGeneral } from "./valueFormatters"
...
export async function BudgetMath(sum : number, prefferedCurr : string, budget : [number, string]) : Promise<[number, number]>{
    const [budgetAmount, budgetCurrency] = budget
    const sumInBudgetCurrency = await standardizeCurrencyGeneral(sum, prefferedCurr, budgetCurrency)
