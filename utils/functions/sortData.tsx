...
export function sortData(sortBy: any, expenses: ExpenseType[]) {
    if (sortBy[0] === 1 && sortBy[1] === 1) {
        return expenses.sort((a: ExpenseType, b: ExpenseType) =>
        ...
        return expenses.sort(
            (a: ExpenseType, b: ExpenseType) => a.amount - b.amount
        )
    } else if (sortBy[0] === 3 && sortBy[1] === 2) {
        return expenses.sort(
            (a: ExpenseType, b: ExpenseType) => b.amount - a.amount
        )
    } else if (sortBy[0] === 4 && sortBy[1] === 1) {
        return expenses.sort((b: ExpenseType, a: ExpenseType) => {
