        ...
        <Dialog.Panel className={`rounded-md  bg-white dark:bg-black relative w-full max-w-2xl max-h-full border-2 border-red-600 dark:border-red-600`}>
            ...
            <div className='items-center p-6 bg-red-500 space-x-2 border-t border-gray-200 rounded-b dark:border-white grid grid-cols-3 grid-rows-1'>
                <button 
                    ...
                    className={`text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 row-start-1 font-medium rounded-lg text-sm px-5 py-2.5 text-center col-start-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:bg-blue-600/30 disabled:dark:hover:bg-blue-600/30`}
                    onClick={async()=>{
                            setLoading(!loading)
                            await submitForm({
                                label: transactionLabel,
                ...
                <button data-modal-hide="defaultModal" type="button" className="text-gray-500 bg-white col-start-3 row-start-1 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600" onClick={()=>{props.setIsOpen(false)}}>Nevermind</button>
            </div>
        </Dialog.Panel>
        </div>
    </Dialog>
