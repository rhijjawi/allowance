...
export function ExpenditureDialog(props: {
    isOpen: boolean
    ...
    async function submitForm(fields: {
        ...
        if (!inv) {
            getToken({ template: 'supabase' })
                .then(async (token) => getSupabase(token))
                .then((supabase) => {
                    ...
                    let data: ExpenseType = {
                        ...
                        refunded: false,
                        transaction_date: new Date(date) as Date,
                        user_id: user!.id,
                        files: [],
                    }
                                    ...
                                    <div className="text-base leading-relaxed text-gray-500 ">
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 grid-rows-2">
                                                ...
                                                <label
                                                    htmlFor="expLabel"
                                                    className="row-span-1 col-span-1 row-start-1 col-start-2 text-sm font-medium leading-6 text-gray-900 pt-3 "
                                                >
                                                    Category
                                                </label>
                                                <select
                                            ...
                                            <label
                                                htmlFor="expLabel"
                                                className="inline-block text-sm font-medium relative leading-6 text-gray-900 mt-4 "
                                            >
...
export function IncomeDialogue(props: {
    isOpen: boolean
    ...
    async function submitForm(fields: {
        ...
        if (!inv) {
            getToken({ template: 'supabase' }).then((token) =>
                getSupabase(token).then((supabase) => {
                    //@ts-ignore
                    let date = new Date(transactionDate)
                    date.setUTCHours(12)
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        <Transition.Child
                            ...
                            leaveTo="opacity-0 scale-95"
                        >
                            <Dialog.Panel className="w-full max-w-lg transform rounded-2xl bg-white dark:bg-dark-tremor-brand-faint p-6 text-left align-middle shadow-xl transition-all">
                                <Dialog.Title
                                    as="h3"
                                    ...
                                    <div className="text-base leading-relaxed text-gray-500">
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 grid-rows-2">
                                                <label
                                                    htmlFor="expLabel"
                                                    className="row-span-1 col-span-1 text-sm font-medium leading-6 text-gray-900 pt-3 dark:text-white"
                                                >
                                                    Date
                                                </label>
                                                <DatePicker
                                                ...
                                                <label
                                                    htmlFor="expLabel"
                                                    className="row-span-1 col-span-1 row-start-1 col-start-2 text-sm font-medium leading-6 text-gray-900 pt-3 dark:text-white"
                                                >
                                                    Category
                                                </label>
                                                <select
                                            ...
                                            <label
                                                htmlFor="expLabel"
                                                className="inline-block text-sm font-medium relative leading-6 text-gray-900 mt-4 dark:text-white"
                                            >
                                                Is this part of your recurring
                                                Income? (Monthly)
                                            </label>
                                            <input
                                                type="checkbox"
                                            ...
                                            <div className="h-12 grid grid-cols-2 grid-rows-1 mb-5 gap-3">
                                                <div className="col-start-1 col-span-1 ">
                                                    <label
                                                        htmlFor="price"
                                                        className="block text-sm font-medium leading-6 text-gray-900 pt-3 dark:text-white"
                                                    >
                                                        Amount
                                                    </label>
                                    ...
                                    >
                                        {loading ? (
                                            <svg
                                                aria-hidden="true"
                                                role="status"
                                                className="inline w-4  h-4 mr-3 text-white animate-spin dark:text-white"
                                                viewBox="0 0 100 101"
                                                fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                            >
