...
export function SavingsModal({
    ...
    misc: any
    setMisc: React.Dispatch<SetStateAction<any>>
}) {
            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="max-w-[45%] w-fit min-w-md transform  rounded-2xl bg-white dark:bg-dark-tremor-background-subtle p-6 text-left align-middle shadow-xl transition-all z-30">
                                <Dialog.Title
                                    as="h3"
