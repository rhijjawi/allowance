    ...
    return (
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <motion.div className="hidden lg:flex lg:flex-1 lg:justify-end">
                ...
                : <motion.button onClick={()=>{router.push(`/sign-in?redirect_url=${router.asPath}`)}} className='w-fit py-2 px-4 text-sm bg-indigo-600 rounded-md cursor-pointer text-white'>Log In / Sign Up</motion.button>}
            </motion.div>
        </nav>
