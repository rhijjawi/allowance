...
export default function CircleJumpingButton() {
    ...
    function changeVis() {
        if (
            document.getElementById('cta-box')?.getClientRects()[0]!.y! -
                window.scrollY >
            500
        ) {
            setVisiblity(true)
        ...
        <>
            {visiblity && (
                <div
                    ...
                    className="w-12 h-12 z-[100] bg-white rounded-full border fixed bottom-0 left-0 right-0 mx-auto mb-10 cursor-pointer"
                >
